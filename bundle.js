...
var Topping = function () {
    ...
    _createClass(Topping, [{
        ...
        key: 'checkCollision',
        value: function checkCollision(other) {
...
var Slice = function (_Topping) {
    _inherits(Slice, _Topping);
...
var Olive = function (_Topping2) {
    _inherits(Olive, _Topping2);

    function Olive() {
        _classCallCheck(this, Olive);

        var _this2 = _possibleConstructorReturn(this, (Olive.__proto__ || Object.getPrototypeOf(Olive)).call(this));
...
var Pizza = function (_Topping3) {
    _inherits(Pizza, _Topping3);

    function Pizza() {
        _classCallCheck(this, Pizza);

        var _this3 = _possibleConstructorReturn(this, (Pizza.__proto__ || Object.getPrototypeOf(Pizza)).call(this));

        _this3.width = 50;
        _this3.height = 30;
        _this3.points = 25;
        _this3.img = wholePizza;
        _this3.reset();
        return _this3;
    }
...
function animate() {
    ...
    slices.forEach(function (slice) {
        return slice.checkCollision(tower);
    });
    olives.forEach(function (olive) {
        return olive.checkCollision(tower);
    });
    pizzas.forEach(function (pizza) {
        return pizza.checkCollision(tower);
    });
